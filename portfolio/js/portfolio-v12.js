...
function init () {
  ...
  // Log messages when the user clicks certain parts of the page
  $('#subtitle').click(function () {
    console.log('The guest clicked the subtitle.')
  })
  $('.thumbnail').mouseover(function () {
    console.log('The guest moved the mouse over an article thumbnail image.')
  })
  $('img').contextmenu(function () {
    console.log('The guest right-clicked an image.')
  })
}
$(document).ready(init)
